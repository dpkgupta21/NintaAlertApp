...
namespace WSI_NintaBlackBoxAlert_App.Droid.Source.CustomViews
{
    ...
    /// </summary>
    public class CustomLtTextView : TextView
    {
        public CustomLtTextView(Context context, IAttributeSet attrs, int defStyle): base(context, attrs, defStyle)
        {           
            if (!IsInEditMode)
            {
                init(attrs);
        ...
        public CustomLtTextView(Context context, IAttributeSet attrs): base(context, attrs)
        {
        ...
        public CustomLtTextView(Context context): base(context)
        {
        ...
        private void init(IAttributeSet attrs)
        {
            if (attrs != null)
            {
                ...
                String fontName = "HelveticaNeueLTStd-Lt.otf";
                if (fontName != null)
                {
