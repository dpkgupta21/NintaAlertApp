...
extern void *mono_aot_module_WSI_NintaBlackBoxAlert_App_iOS_info;
...
extern void *mono_aot_module_Xamarin_SWRevealViewController_info;
...
{
	mono_aot_register_module (mono_aot_module_WSI_NintaBlackBoxAlert_App_iOS_info);
	...
	mono_aot_register_module (mono_aot_module_Xamarin_SWRevealViewController_info);
...
void xamarin_setup_impl ()
{
	...
	xamarin_executable_name = "WSI.NintaBlackBoxAlert.App.iOS.exe";
	mono_use_llvm = FALSE;
	xamarin_log_level = 2;
